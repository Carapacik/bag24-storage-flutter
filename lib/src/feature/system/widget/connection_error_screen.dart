            ...
            child: Column(
              children: [
                ...
                Column(
                  ...
                  children: [
                    Image.asset(Assets.images.denied.path, height: imageDimension, width: imageDimension),
                    const SizedBox(height: 20),
                    Text(
                      context.l10n.failedToUploadData,
                      style: context.textStyles.title2Emphasized,
                      textAlign: TextAlign.center,
                    ),
                    const SizedBox(height: 12),
                    Text(
                      context.l10n.checkYourInternetConnectionAndTryAgain,
