...
class CustomTonalButton extends StatelessWidget {
  const new({required this.onPressed, this.child, this.text, this.backgroundColor, this.foregroundColor, super.key})
  ...
  Widget build(BuildContext context) {
    return FilledButton(
      style: FilledButton.styleFrom(
        ...
        disabledBackgroundColor: context.colors.buttonBgDisabled,
