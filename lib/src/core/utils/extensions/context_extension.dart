...
import 'package:bag24/src/core/utils/extensions/text_style_by_window_size.dart';
import 'package:bag24/src/core/utils/extensions/theme_extension.dart';
...
extension ContextX on BuildContext {
  ...
  /// Get text styles by width
  TextStyleByWindowSize get textStyles => TextStyleByWindowSize(this);

  /// Get colors extension
  ColorsX get colors => Theme.of(this).extension<ColorsX>()!;

  /// Get icons extension
  IconsX get icons => Theme.of(this).extension<IconsX>()!;
}
